...
> * The output will look like ![Output](https://imgur.com/v9Rt2Z5) where it will prompt the user for input everyday. As of now, the game will end whenever the user reaches X amount of rounds or the character dies.
